  ...
  return (
    <div className="w-full pt-8 gap-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
      ...
      <StatsCard
        ...
        helperText="Visitts that result in form submission"
    ...
    <Card className={className}>
      ...
      <CardContent>
        <div className="text-2xl font-bold">
          {loading && (
            <Skeleton className=" rounded-lg opacity-10">
      ...
      <CardFooter>
        {
          form.published && (
            <Button asChild className=" w-full mt-2 text-muted gap-4">
              <Link href={`/forms/${form.id}`} className=" text-white">
        ...
        {
          !form.published && (
            <Button asChild className=" w-full mt-2 text-muted gap-4 flex flex-row" variant={"secondary"}>
              <Link href={`/builder/${form.id}`} className=" text-white">
                Edit form <FaEdit/>
              </Link>
            </Button>
          )
